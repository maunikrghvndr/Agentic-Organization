...
- Confirm the change is minimal, sits in the right component/hook/service, reuses existing patterns, avoids parallel architecture, and is easy to review and roll back.
